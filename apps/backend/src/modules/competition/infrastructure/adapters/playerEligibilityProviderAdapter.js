/**
 * The one place competition's infrastructure is allowed to know identity
 ...
 * rules. Reuses identity's existing checkIsJugador use case as-is, matching
 * billing's/coaching's identical adapters.
 *
