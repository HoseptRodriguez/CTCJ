 ...
 * layer (a plain use-case function), never identity's persistence --
 * matches challenges'/competition's identical adapter. getUserSummaries
 * returns email too, but no community use case ever surfaces it -- this
 * is peer-facing author-name display, matching searchPlayers' precedent.
 *
